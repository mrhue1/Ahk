...
mpdf.ahk is the updated code that use libmupdf. The compiled dll that's included is for 64 bit Windows.
PDF loading should be twice as fast. Basic rotation and text copying is also included. 
If you want to build your own libmupdf.dll, you can download it from https://mupdf.com/releases. Build instructions are at https://www.codeproject.com/Articles/1190061/Compiling-MuPDF-DLL-to-Render-and-Edit-PDF-Documen. 
